...
#     print("RAW TEXT LENGTH:", len(parsed_resume["raw_text"]))
#     print("RAW TEXT PREVIEW:", parsed_resume["raw_text"][:500])

#     return {
#         "filename": file.filename,
#         "resume_text": parsed_resume["raw_text"],   # ✅ IMPORTANT FIX
#         "resume_text_preview": parsed_resume["raw_text"][:1000],
#         "sections": parsed_resume["sections"],
#         "extracted_skills": skills
#     }
...
async def upload_resume(file: UploadFile = File(...)):
    ...
    return {
        "filename": file.filename,
        "resume_text": parsed_resume["raw_text"],   # IMPORTANT
        "resume_text_preview": parsed_resume["raw_text"][:1000],
        "sections": parsed_resume["sections"],
        "extracted_skills": skills
    }